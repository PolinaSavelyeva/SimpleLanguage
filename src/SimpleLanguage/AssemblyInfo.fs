...
[<assembly: AssemblyTitleAttribute("SimpleLanguage")>]
[<assembly: AssemblyProductAttribute("SimpleLanguage")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "SimpleLanguage"
    let [<Literal>] AssemblyProduct = "SimpleLanguage"
